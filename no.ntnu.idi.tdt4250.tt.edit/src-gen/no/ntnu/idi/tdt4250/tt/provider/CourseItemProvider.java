...
/**
 * This is the item provider adapter for a {@link no.ntnu.idi.tdt4250.tt.Course} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CourseItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addCoordinatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Course_coordinator_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Course_coordinator_feature",
								"_UI_Course_type"),
						TtPackage.Literals.COURSE__COORDINATOR, true, false, true, null, null, null));
	}
	...
	protected void addDepartmentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Course_department_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Course_department_feature",
								"_UI_Course_type"),
						TtPackage.Literals.COURSE__DEPARTMENT, true, false, true, null, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						TtPackage.Literals.COURSE__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TtPackage.Literals.COURSE__TIMESLOT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(TtPackage.Literals.COURSE__TIMESLOT, TtFactory.eINSTANCE.createTimeSlot()));
	}
