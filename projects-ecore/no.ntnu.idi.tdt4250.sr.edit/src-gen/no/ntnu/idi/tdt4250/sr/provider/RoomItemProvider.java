...
/**
 * This is the item provider adapter for a {@link no.ntnu.idi.tdt4250.sr.Room} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoomItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addCapacityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						SrPackage.Literals.ROOM__CAPACITY, true, false, false,
	...
	protected void addIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						SrPackage.Literals.ROOM__ID, true, false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
						null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SrPackage.Literals.ROOM__TIMESLOT);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Room_type") + " " + room.getID();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case SrPackage.ROOM__CAPACITY:
		case SrPackage.ROOM__ID:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case SrPackage.ROOM__TIMESLOT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(SrPackage.Literals.ROOM__TIMESLOT, SrFactory.eINSTANCE.createTimeSlot()));
	}
