 ...
 * </p>
 * <ul>
 *   <li>{@link no.ntnu.idi.tdt4250.sr.impl.CampusBuildingImpl#getRoom <em>Room</em>}</li>
 *   <li>{@link no.ntnu.idi.tdt4250.sr.impl.CampusBuildingImpl#getID <em>ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CampusBuildingImpl extends MinimalEObjectImpl.Container implements CampusBuilding {
	...
	protected EClass eStaticClass() {
		return SrPackage.Literals.CAMPUS_BUILDING;
	}
	...
	public EList<Room> getRoom() {
		if (room == null) {
			room = new EObjectContainmentEList<Room>(Room.class, this, SrPackage.CAMPUS_BUILDING__ROOM);
		}
		return room;
	}
	...
	public void setID(int newID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SrPackage.CAMPUS_BUILDING__ID, oldID, id));
	}
