 ...
 * </p>
 * <ul>
 *   <li>{@link no.ntnu.idi.tdt4250.tt.impl.CampusImpl#getCampusbuilding <em>Campusbuilding</em>}</li>
 *   <li>{@link no.ntnu.idi.tdt4250.tt.impl.CampusImpl#getName <em>Name</em>}</li>
 *   <li>{@link no.ntnu.idi.tdt4250.tt.impl.CampusImpl#getID <em>ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CampusImpl extends MinimalEObjectImpl.Container implements Campus {
	...
	protected EClass eStaticClass() {
		return TtPackage.Literals.CAMPUS;
	}
	...
	public EList<CampusBuilding> getCampusbuilding() {
		if (campusbuilding == null) {
			campusbuilding = new EObjectContainmentEList<CampusBuilding>(CampusBuilding.class, this,
					TtPackage.CAMPUS__CAMPUSBUILDING);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TtPackage.CAMPUS__NAME, oldName, name));
	}
	...
	public void setID(int newID) {
		...
		id = newID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TtPackage.CAMPUS__ID, oldID, id));
	}
